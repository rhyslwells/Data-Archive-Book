...
![Pasted image 20250126135722.png|500](./images/Pasted%20image%2020250126135722.png|500)
...
![Pasted image 20241230202826.png|500](./images/Pasted%20image%2020241230202826.png|500)
...
![Pasted image 20240524130607.png](./images/Pasted%20image%2020240524130607.png)
...
![Pasted image 20240524131311.png|500](./images/Pasted%20image%2020240524131311.png|500)
...
![Pasted image 20240524131603.png](./images/Pasted%20image%2020240524131603.png)
...
The `GradientBoostingRegressor` from the `sklearn.ensemble` module is a model used for regression tasks. It builds an [Model Ensemble](#model-ensemble) of [Decision Tree](#decision-tree) in a sequential manner, where each tree tries to correct the errors made ==by the previous ones==. Here’s a breakdown of the key parameters:
...
![Obsidian_EPIqLAto5w.png|500](./images/Obsidian_EPIqLAto5w.png|500)

![Obsidian_FEGflF5RKQ.png|500](./images/Obsidian_FEGflF5RKQ.png|500)
...
![Obsidian_M4mzGSAx7d.png|500](./images/Obsidian_M4mzGSAx7d.png|500)
...
![Pasted image 20241224082847.png](./images/Pasted%20image%2020241224082847.png)
...
![Pasted image 20240128194244.png|500](./images/Pasted%20image%2020240128194244.png|500)

# Groupby Vs Crosstab {#groupby-vs-crosstab}

In pandas, [Groupby](#groupby) and [Crosstab](#crosstab) serve related but distinct purposes for data ==aggregation== and summarization.
...
![Pasted image 20250323081619.png](./images/Pasted%20image%2020250323081619.png)
...
![Pasted image 20250402212849.png](./images/Pasted%20image%2020250402212849.png)
