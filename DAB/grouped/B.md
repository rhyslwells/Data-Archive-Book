...
BERT (==Bidirectional Encoder Representations from [Transformer](#transformer)==) is used in [NLP](#nlp)processing, developed by [Google](#google). 
...
![Pasted image 20241219071904.png](./images/Pasted%20image%2020241219071904.png)
...
Boosting is a type of [Model Ensemble](#model-ensemble) in machine learning that focuses on improving the accuracy of predictions by building a ==sequence of models==.    Each subsequent model focuses on correcting the errors made by the previous ones.
