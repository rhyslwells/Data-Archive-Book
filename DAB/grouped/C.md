...
![Pasted image 20240404163858.png|500](./images/Pasted%20image%2020240404163858.png|500)
...
The non-recursive are simple where CTE is used to ==avoid SQL duplication== by referencing a name instead of the actual SQL statement. See [Views](#views) simplification usage.
...
![Pasted image 20240916075433.png](./images/Pasted%20image%2020240916075433.png)

![Pasted image 20240916075439.png](./images/Pasted%20image%2020240916075439.png)
...
![Obsidian_CSP0FnAVD1.png](./images/Obsidian_CSP0FnAVD1.png)
...
![Pasted image 20240120215414.png](./images/Pasted%20image%2020240120215414.png)
...
## Further Examples
![Pasted image 20240116205937.png|500](./images/Pasted%20image%2020240116205937.png|500)

![Pasted image 20240116210541.png|500](./images/Pasted%20image%2020240116210541.png|500)
...
![Pasted image 20241006124829.png|500](./images/Pasted%20image%2020241006124829.png|500)

![Pasted image 20241006124735.png|500](./images/Pasted%20image%2020241006124735.png|500)
...
If two variables are strongly positively correlated, it often makes sense to drop one of them to simplify the model. This is because ==highly correlated variables can introduce redundancy==, leading to [multicollinearity](#multicollinearity) in regression models.
...
![Pasted image 20241216202825.png|500](./images/Pasted%20image%2020241216202825.png|500)

![Pasted image 20241216202917.png|500](./images/Pasted%20image%2020241216202917.png|500)
...
Cross-validation is a statistical technique used in machine learning to ==assess how well a model will generalize== to an independent dataset. It is a crucial step in the model-building process because it helps ensure that the model is not [overfitting](#overfitting) or underfitting the training data.
