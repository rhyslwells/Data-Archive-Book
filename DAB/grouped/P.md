...
![Pasted image 20250317093551.png](./images/Pasted%20image%2020250317093551.png)
...
![Pasted image 20241204203338.png](./images/Pasted%20image%2020241204203338.png)

Categorical Example

![Pasted image 20241204203413.png](./images/Pasted%20image%2020241204203413.png)
...
![Pasted image 20250113072251.png](./images/Pasted%20image%2020250113072251.png)
...
In [reinforcement learning](#reinforcement-learning) (RL), a **policy** is a strategy or a rule that defines the actions an agent takes in a given state to achieve its goals. It essentially ==maps states of the environment to actions that the agent should take when in those states.==
...
![Pasted image 20250329081752.png](./images/Pasted%20image%2020250329081752.png)
...
![Pasted image 20240116211130.png](./images/Pasted%20image%2020240116211130.png)
...
![Pasted image 20241231172749.png](./images/Pasted%20image%2020241231172749.png)
...
It transforms the original data into a new coordinate system defined by the principal components, which are ==orthogonal vectors== that capture the most [Variance](#variance) in the data.

It helps simplify models, enhances [interpretability](#interpretability), and improves computational efficiency by transforming data into a lower-dimensional space while ==retaining the most significant variance==, and reducing noise.


### How PCA Works

- ==Linear Technique==: PCA is a linear technique, meaning it assumes that the relationships between features are linear. This distinguishes it from methods like [Manifold Learning](#manifold-learning) which can capture non-linear relationships.
...
<mark style="background: #FF5582A6;">Python API </mark>for [Apache Spark](#apache-spark), a ==distributed processing framework== for big data analysis and machine learning on clusters.
...
**Parsimonious** refers to a principle in [Model Selection](#model-selection) and statistical modeling that emphasizes ==simplicity==. In the context of regression and other statistical models, a parsimonious model is one that explains the data with the fewest possible parameters or predictors while still providing a good fit.
