...
for letter, entries in sorted(grouped_files.items()):
    ...
    with open(out_path, 'w', encoding='utf-8') as out_file:
        for _, cleaned_content, _, _ in entries:
            out_file.write(f"\n\n{cleaned_content}")
...
with open(summary_path, 'w', encoding='utf-8') as summary:
    ...
    for letter in sorted(grouped_files.keys()):
        ...
        for filename, _, anchor, subheadings in grouped_files[letter]:
            ...
            # Add subheadings under each file
            for sub_title, sub_anchor in subheadings:
                summary.write(f"    * [{sub_title}](./grouped/{letter}.md#{sub_anchor})\n")

print("📘 Created grouped content and updated SUMMARY.md with subheadings.")
